              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?= form_open_multipart("products/save",array("id" => "formproducts"),array("method" => "edit","id" => $data['product_id']));?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Merk" placeholder="Merk Product" name="merk" value="<?= $data['merk']; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control froala-editor" id="deskripsi" rows="3" name="deskripsi"><?= $data['deskripsi']; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label for="link">Gambar</label>
                        <div class="col-xl-7 m-auto">
                          <img src="<?= base_url('assets/product-img/'.$data['gambar']); ?>" class="img img-rounded w-100">
                        </div>
